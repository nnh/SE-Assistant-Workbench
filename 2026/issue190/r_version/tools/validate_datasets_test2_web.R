...
check_lb_testcd(lb_done, "RBC", 100, "_4", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "HGB", 100, "_5", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "HCT", 100, "_6", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "WBC", 100, "_7", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "NEUT", 100, "_8", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "PLAT", 100, "_9", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "ALB", 100, "_10", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "SODIUM", 100, "_11", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "K", 100, "_12", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "CL", 100, "_13", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "CA", 100, "_14", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "PHOS", 100, "_15", fixed_value_checks_csv_path)
check_lb_testcd(filter(lb_done, LBCAT=="CHEMISTRY"), "GLUC", 100, "_16", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "UREAN", 100, "_17", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "CYURIAC", 100, "_18", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "CREAT", 100, "_19", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "BILI", 100, "_20", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "AST", 100, "_21", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "ALT", 100, "_22", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "ALP", 100, "_23", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "LDH", 100, "_24", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "HBA1C", 100, "_25", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "CHOL", 100, "_26", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "TRIG", 100, "_27", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "INR", 100, "_28", fixed_value_checks_csv_path, has_unit = FALSE)
check_lb_testcd(lb_done, "APTT", 100, "_29", fixed_value_checks_csv_path)
check_lb_testcd(lb_done, "HBSAG", 100, "_30", fixed_value_checks_csv_path, has_unit = FALSE)
check_lb_testcd(lb_done, "HBSAB", 100, "_31", fixed_value_checks_csv_path, has_unit = FALSE)
check_lb_testcd(lb_done, "HBCAB", 100, "_32", fixed_value_checks_csv_path, has_unit = FALSE)
check_lb_testcd(lb_done, "HCAB", 100, "_33", fixed_value_checks_csv_path, has_unit = FALSE)
check_lb_testcd(filter(lb_done,LBCAT=="URINALYSIS"), "PROT", 100, "_34", fixed_value_checks_csv_path, has_unit = FALSE)
check_lb_testcd(filter(lb_done,LBCAT=="URINALYSIS"), "GLUC", 100, "_35", fixed_value_checks_csv_path, has_unit = FALSE)
# MH
...
check_vs_testcd(vs_done, "TEMP", 200, 10, "_3", fixed_value_checks_csv_path)
check_vs_testcd(vs_done, "TEMP", 200, 10, "_3", fixed_value_checks_csv_path, has_blfl = FALSE)
check_vs_testcd(vs_done, "PULSE", 200, 10, "_4", fixed_value_checks_csv_path)
check_vs_testcd(vs_done, "PULSE", 200, 10, "_4", fixed_value_checks_csv_path, has_blfl = FALSE)
check_vs_testcd(vs_done, "SYSBP", 200, 10, "_5", fixed_value_checks_csv_path)
check_vs_testcd(vs_done, "SYSBP", 200, 10, "_5", fixed_value_checks_csv_path, has_blfl = FALSE)
check_vs_testcd(vs_done, "DIABP", 200, 10, "_6", fixed_value_checks_csv_path)
check_vs_testcd(vs_done, "DIABP", 200, 10, "_6", fixed_value_checks_csv_path, has_blfl = FALSE)
