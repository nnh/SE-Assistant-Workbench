...
target_visitnum <- 300
check_lb_testcd(lb_done, "RBC", target_visitnum, "_4", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "HGB", target_visitnum, "_5", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "HCT", target_visitnum, "_6", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "WBC", target_visitnum, "_7", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "NEUT", target_visitnum, "_8", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "PLAT", target_visitnum, "_9", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "ALB", target_visitnum, "_10", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "SODIUM", target_visitnum, "_11", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "K", target_visitnum, "_12", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "CL", target_visitnum, "_13", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "CA", target_visitnum, "_14", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "PHOS", target_visitnum, "_15", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(filter(lb_done, LBCAT=="CHEMISTRY"), "GLUC", target_visitnum, "_16", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "UREAN", target_visitnum, "_17", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "CYURIAC", target_visitnum, "_18", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "CREAT", target_visitnum, "_19", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "BILI", target_visitnum, "_20", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "AST", target_visitnum, "_21", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "ALT", target_visitnum, "_22", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "ALP", target_visitnum, "_23", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "LDH", target_visitnum, "_24", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "HBA1C", target_visitnum, "_25", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "CHOL", target_visitnum, "_26", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "TRIG", target_visitnum, "_27", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(lb_done, "INR", target_visitnum, "_28", fixed_value_checks_csv_path, has_unit = FALSE, has_blfl = FALSE)
check_lb_testcd(lb_done, "APTT", target_visitnum, "_29", fixed_value_checks_csv_path, has_blfl = FALSE)
check_lb_testcd(filter(lb_done,LBCAT=="URINALYSIS"), "PROT", target_visitnum, "_34", fixed_value_checks_csv_path, has_unit = FALSE, has_blfl = FALSE)
check_lb_testcd(filter(lb_done,LBCAT=="URINALYSIS"), "GLUC", target_visitnum, "_35", fixed_value_checks_csv_path, has_unit = FALSE, has_blfl = FALSE)
check_lb_testcd(filter(lb_done,LBCAT=="URINALYSIS"), "OCCBLD", target_visitnum, "_36", fixed_value_checks_csv_path, has_unit = FALSE, has_blfl = FALSE)
# MH
