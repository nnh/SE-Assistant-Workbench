...
export const SHEET_NAME_EDITORS = '編集者一覧';
export const SHEET_NAME_VIEWERS = '閲覧者一覧';
export const SHEET_NAME_EXTERNAL_EDITORS = 'ドメイン外の編集者';
export const SHEET_NAME_EXTERNAL_VIEWERS = 'ドメイン外の閲覧者';
export const SHEET_NAME_EXTERNAL_EDITORS_SUMMARY =
  'ドメイン外の編集者_ファイル別集約';
export const SHEET_NAME_EXTERNAL_VIEWERS_SUMMARY =
  'ドメイン外の閲覧者_ファイル別集約';
