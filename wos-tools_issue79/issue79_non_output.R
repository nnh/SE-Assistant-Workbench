kExcludeHospNameList <- c("(?i)Red Cross",
                          ...
                          "(?i)Japanese Data Ctr Hematopoiet Cell Transplantat, ",
                          "(?i)Anjo Kosei Hosp, ",
                          "(?i)Sapporo Hokuyu Hosp, ",
                          "(?i)Keiwakai Ebetsu Hosp, ",
                          "(?i)Natl Ctr Neurol & Psychiat, ",
                          "(?i)Kochi Hlth Sci Ctr, ",
                          "(?i)St Lukes Int Hosp, ",
                          "(?i)Chiba Childrens Hosp, ",
                          "(?i)Osaka Int Canc Ctr, ",
                          "(?i)Nagasaki Inst Appl Sci, ",
                          "(?i)Sapporo Shirakabadai Hosp, ",
                          "(?i)Natl Inst Infect Dis, ",
                          "(?i)Toyama Inst Hlth, ",
                          "(?i)Tane Gen Hosp, ",
                          "(?i)Osaka Mishima Emergency Crit Care Ctr, ",
                          "(?i)Senshu Trauma & Crit Care Ctr, ",
                          "(?i)Kyusyu Cent Hosp, ",
                          "(?i)Kitakyushu Kokura Hosp, ",
                          "(?i)Konan Med Ctr, ",
                          "(?i)Natl Ctr Neurol & Psychiat, ",
                          "(?i)Cardiovasc Inst, ",
                          "(?i)Natl Inst Publ Hlth, ",
                          "Ctr Gene Res, Ube, Yamaguchi, Japan",
                          "(?i)Natl Def Med Coll")
# ------ functions ------
