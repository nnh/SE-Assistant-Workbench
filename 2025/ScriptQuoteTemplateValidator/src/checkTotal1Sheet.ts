...
export function checkTotal1Sheet_(
  ...
  total1CheckMap.set('F20', specificClinicalResearchFlag ? facilityCount : 0);
  ...
  total1CheckMap.set('F28', monitoring ? 1 : 0);
  ...
  total1CheckMap.set(
    'F77',
    audit ? quotationRequestSheet.getRange('Q2').getValue() : 0
  );
